...
public class DuplicateClassTest extends TestCase {
    ...
    public void testNPEDuplicatedClass() throws IOException {
        ...
        JavacTask ct = (JavacTask)tool.getTask(null, null, null, Arrays.asList("-bootclasspath",  bootPath, "-source", version, "-Xjcov", "--should-stop:at=GENERATE"), null, Arrays.asList(new MyFileObject(code)));
